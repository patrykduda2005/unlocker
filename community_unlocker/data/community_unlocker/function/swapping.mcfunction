...
scoreboard players set __if_else__ __variable__ 0
execute if score $food_tier __variable__ matches 3.. run function community_unlocker:__private__/if_else/4
...
scoreboard players set __if_else__ __variable__ 0
execute if score $mining_tier __variable__ matches 4.. run function community_unlocker:__private__/if_else/9
