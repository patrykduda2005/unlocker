...
function community_unlocker:itemswapper/swap_to_vanilla_item {"item":"430"}
function community_unlocker:itemswapper/swap_to_vanilla_item {"item":"431"}
function community_unlocker:itemswapper/swap_to_vanilla_item {"item":"432"}