...
execute as @a[scores={pay_neth=1..}] at @s run function community_unlocker:__private__/trigger_add/pay_neth
execute as @a[scores={pay_mining=1..}] at @s run function community_unlocker:__private__/trigger_add/pay_mining