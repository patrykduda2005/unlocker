...
execute if score $mining_tier __variable__ matches 2 run tellraw @s ["",{"text":"Killed warden left: ","color":"red"},{"text":"1","color":"gray"}]
execute if score $mining_tier __variable__ matches 3 run tellraw @s ["",{"text":"Nether star left: ","color":"red"},{"color":"gray","score":{"name":"$nether_star_left_cost","objective":"__variable__"},"hoverEvent":{"action":"show_item","contents":{"id":"minecraft:nether_star"}},"type":"score"}]
