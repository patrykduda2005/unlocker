...
execute if score $mining_tier __variable__ matches 3 run tellraw @s ["",{"text":"sth left: ","color":"red"},{"color":"gray","score":{"name":"$nether_star_left_cost","objective":"__variable__"},"type":"score"}]
